<sch:schema queryBinding="xslt2" xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
  ...
  <sch:pattern id="sch_lvbba_023" see="data:heeftGeboorteregeling">
    ...
    <sch:rule
      ...
      <sch:assert id="BHKV1015" role="error" test="//data:heeftGeboorteregeling">{"code": "BHKV1015", "id": "<sch:value-of select="//data:FRBRExpression" />", "melding": "heeftGeboorteregeling voor <sch:value-of select="//data:FRBRExpression" /> is niet aanwezig, is verplicht wanneer soortWork=work_010 èn formaatinformatieobject=gio_002. Voeg de AKN-identificatie voor heeftGeboorteregeling toe.", "ernst": "fout"},</sch:assert>
    </sch:rule>
  </sch:pattern>
  <!--  -->
  <sch:pattern id="sch_lvbba_024">
    ...
    <sch:rule
      ...
      <sch:p>De identificatie van een InformatieObject moet als soort werk '/join/id/stop/work_010'
        zijn</sch:p>
      <sch:assert id="BHKV1016" role="error" test="normalize-space(data:soortWork) = '/join/id/stop/work_010'">{"code": "BHKV1016", "work": "<sch:value-of select="data:soortWork" />", "id": "<sch:value-of select="data:FRBRExpression" />", "melding": "Het aangeleverde informatieobject <sch:value-of select="data:FRBRExpression" /> heeft als soortWork <sch:value-of select="data:soortWork" /> dit moet '/join/id/stop/work_010' zijn.", "ernst": "fout"},</sch:assert>
    </sch:rule>
  </sch:pattern>
  <!--  -->

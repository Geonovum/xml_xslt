...
<xsl:stylesheet 
    ...
    <!-- guids.list bevat het juiste aantal guids -->
    
    <xsl:param name="gmlfile.list"  as="xs:string*"/>
    <xsl:param name="locationfile.list"  as="xs:string*"/>
    <xsl:param name="guids.list"  as="xs:string*"/>

    ...
    <xsl:template match="." mode="list">
        ...
        <xsl:element name="UL">
            ...
            <xsl:element name="LI">Regeling: 
                ...
                <xsl:element name="UL">
                    <xsl:element name="LI">Wordt: <xsl:element name="FONT"><xsl:attribute name="style" select="'font-weight:bold'"/><xsl:value-of select="./*[local-name()='BesluitVersie']/*[local-name()='BesluitCompact']/*[local-name()='WijzigBijlage']/*[local-name()='RegelingCompact']/@wordt" /></xsl:element>
                    </xsl:element>
                </xsl:element>
                <xsl:element name="UL">

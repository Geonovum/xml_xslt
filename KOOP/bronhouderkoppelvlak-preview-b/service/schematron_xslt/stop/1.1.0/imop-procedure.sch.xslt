...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--RULE -->
   <xsl:template match="data:procedurestappen" priority="1000" mode="M4">
         ...
         <xsl:for-each xmlns:sch="http://purl.oclc.org/dsdl/schematron"
            ...
            <stap>
               ...
               <xsl:choose>
                  ...
                  <xsl:when test="$code = '/join/id/stop/procedure/stap_019'">
                     <exclusief_voor_definitief>1</exclusief_voor_definitief>
                     <in_beroep>in</in_beroep>
                     <geschorst>start</geschorst>
                     <datum_sorteervolgorde>221</datum_sorteervolgorde>
                  </xsl:when>
                  <xsl:when test="$code = '/join/id/stop/procedure/stap_020'">
                     <exclusief_voor_definitief>1</exclusief_voor_definitief>
                     <in_beroep>in</in_beroep>
      ...
      <xsl:variable name="json_STOP1319">
         <xsl:choose xmlns:sch="http://purl.oclc.org/dsdl/schematron"
                     xmlns:sqf="http://www.schematron-quickfix.com/validator/process">
            <xsl:when test="$stappen/stap[code = '/join/id/stop/procedure/stap_018']">
            ...
            <xsl:when test="$stappen/stap[code = '/join/id/stop/procedure/stap_016']">
               <xsl:if test="not ($stappen/stap[code = '/join/id/stop/procedure/stap_003'])"> 
            ...
            <xsl:when test="$stappen/stap[code = '/join/id/stop/procedure/stap_014']">
            ...
            <xsl:when test="$stappen/stap[code = '/join/id/stop/procedure/stap_004']">
               <xsl:if test="not ($stappen/stap[code = '/join/id/stop/procedure/stap_003'])"> 
              {"code": "STOP1319", "soortStap1": "/join/id/stop/procedure/stap_004", "soortStap2": "/join/id/stop/procedure/stap_003", "melding": "De stap /join/id/stop/procedure/stap_003 moet vermeld worden als ook stap /join/id/stop/procedure/stap_004 in het procedureverloop voorkomt.", "ernst": "fout"},</xsl:if>
            </xsl:when>
            <xsl:when test="$stappen/stap[code = '/join/id/stop/procedure/stap_015']">
               <xsl:if test="not ($stappen/stap[code = '/join/id/stop/procedure/stap_003'])"> 
      ...
      <!--ASSERT fout-->
      <xsl:choose>
         <xsl:when test="normalize-space($json_STOP1319/./string()) = ''"/>
         <xsl:otherwise>
            <xsl:text/>
            <xsl:value-of select="$json_STOP1319/./string()"/>
            <xsl:text/>
      ...
      <xsl:variable name="json_STOP1310_tm_STOP1312">
         <xsl:for-each xmlns:sch="http://purl.oclc.org/dsdl/schematron"
                       xmlns:sqf="http://www.schematron-quickfix.com/validator/process"
      ...
      <!--ASSERT fout-->
      <xsl:choose>
         <xsl:when test="normalize-space($json_STOP1310_tm_STOP1312/./string()) = ''"/>
         <xsl:otherwise>
            <xsl:text/>
            <xsl:value-of select="$json_STOP1310_tm_STOP1312/./string()"/>
            <xsl:text/>
            <xsl:value-of select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:variable name="json_STOP1313_tm_STOP1315">
         <xsl:for-each xmlns:sch="http://purl.oclc.org/dsdl/schematron"
                       xmlns:sqf="http://www.schematron-quickfix.com/validator/process"
      ...
      <!--ASSERT fout-->
      <xsl:choose>
         <xsl:when test="normalize-space($json_STOP1313_tm_STOP1315/./string()) = ''"/>
         <xsl:otherwise>
            <xsl:text/>
            <xsl:value-of select="$json_STOP1313_tm_STOP1315/./string()"/>
            <xsl:text/>
            <xsl:value-of select="string('&#xA;')"/>
         </xsl:otherwise>
      </xsl:choose>

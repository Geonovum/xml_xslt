...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN sch_uws_004Component in een pakbon heeft id-module-->
   <!--RULE STOP1208-->
   <xsl:template match="uws:Component" priority="1000" mode="M13">

		<!--ASSERT waarschuwing-->
      <xsl:choose>
         <xsl:when test="uws:heeftModule/uws:Module[uws:namespace=$nsd][normalize-space(uws:localName)='ExpressionIdentificatie']         |uws:heeftModule/uws:Module[uws:namespace=$nsc][normalize-space(uws:localName)='ConsolidatieIdentificatie']"/>
         <xsl:otherwise>

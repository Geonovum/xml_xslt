...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Officiele titel -->
    <xsl:variable name="offTtl"
        select="string('Voorbeeldregels met uitbreiding tbv Toepasbare Regels')"/>
    <!-- Onderwerp -->
    ...
    <xsl:template match="/">
        <BesluitVersie schemaversie="0.98.kern"
    ...
    <xsl:template match="//tekst:NieuweRegeling"
        xmlns:tekst="https://standaarden.overheid.nl/stop/imop/tekst/">
        <xsl:copy>

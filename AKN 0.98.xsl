...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns="https://standaarden.overheid.nl/stop/imop/tekst/" xpath-default-namespace="https://standaarden.overheid.nl/stop/imop/tekst/">
    ...
    <xsl:param name="element" select="('Afdeling','Artikel','Begrip','Begrippenlijst','Bijlage','Aanhef','Boek','Citaat','Deel','Divisie','ExtIoRef','Figuur','FormeleDivisie','FormeleInhoud','Hoofdstuk','Inline','Inhoudsopgave','IntIoRef','Li','Lichaam','Lid','Lijst','Nawerk','Ondertekening','RegelingOpschrift','Paragraaf','Slotformulier','Subparagraaf','Subsubparagraaf','table','table_html5','Tekst','Titel','Toelichting','WijzigArtikel','WijzigBijlage','WijzigLid')"/>
    <xsl:param name="element_ref" select="('subchp','art','item','list','cmp','formula_1','book','cit','part','dvs','ref','img','fdvs','fcontent','chp','inline','toc','ref','item','body','para','list','app','signature','longTitle','subsec','formula_2','subsec','subsec','table','table','body','title','recital','art','cmp','para')"/>
    <xsl:param name="element_wId_eId" select="('onwaar','onwaar','onwaar','onwaar','onwaar','waar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','waar','onwaar','onwaar','waar','onwaar','onwaar','waar','waar','waar','onwaar','waar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar','onwaar')"/>

    <!-- Vul hieronder de identifier voor het bevoegd gezag en het versienummer in. -->

    <xsl:param name="wId_bg" select="string('gm0599')"/>

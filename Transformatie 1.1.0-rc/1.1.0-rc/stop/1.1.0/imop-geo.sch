...
<sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
   ...
   <sch:pattern id="sch_geo_003">
      ...
      <sch:rule context="geo:groepID">
         ...
         <sch:report id="STOP3002" test="normalize-space(./string()) = ''" role="fout">
        {"code": "STOP3002", "melding": "Als GroepID voorkomt mag het niet leeg zijn. Geef een correcte groepID.", "ernst": "fout"},</sch:report>
      </sch:rule>
   </sch:pattern>
   <sch:pattern id="sch_geo_004">
      ...
      <sch:rule context="geo:groepen">
         ...
         <sch:assert id="STOP3003"
                     test="count(./geo:Groep/geo:groepID) = count(distinct-values(./geo:Groep/geo:groepID))"
                     role="fout">
        {"code": "STOP3003", "melding": "Een groepID komt meerdere keren voor. Geef unieke groepIDs.", "ernst": "fout"},</sch:assert>
         <sch:assert id="STOP3004"
                     test="count(./geo:Groep/geo:label) = count(distinct-values(./geo:Groep/geo:label))"
                     role="fout">
   ...
   <sch:pattern id="sch_basisgeo_001">
      ...
      <sch:rule context="basisgeo:geometrie">
         ...
         <sch:assert id="STOP3019"
                     ...
                     role="fout"> 
        {"code": "STOP3019", "locatienaam": "<sch:value-of select="ancestor::geo:Locatie/geo:naam"/>", "basisgeo:id": "<sch:value-of select="preceding-sibling::basisgeo:id"/>", "ExpressieID": "<sch:value-of select="ancestor::geo:GeoInformatieObjectVersie/geo:FRBRExpression"/>", "melding": "Een locatie(<sch:value-of select="ancestor::geo:Locatie/geo:naam"/>) in de GIO(<sch:value-of select="ancestor::geo:GeoInformatieObjectVersie/geo:FRBRExpression"/> heeft geen of een lege basisgeo:geometrie(<sch:value-of select="preceding-sibling::basisgeo:id"/>). Een locatie zonder geometrie is niet toegestaan. Voeg een (correcte) basisgeo:geometrie toe.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern id="sch_gml_002">
      ...
      <sch:rule context="geo:locaties">
         ...
         <sch:assert id="STOP3021"
                     ...
                     role="fout">
        {"code": "STOP3021", "srsNames": "<sch:value-of select="distinct-values($srsName)"/>", "ExpressieID": "<sch:value-of select="ancestor::geo:GeoInformatieObjectVersie/geo:FRBRExpression"/>", "melding": "In GIO(<sch:value-of select="ancestor::geo:GeoInformatieObjectVersie/geo:FRBRExpression"/>) heeft niet elke geometrie dezelfde srsName (<sch:value-of select="distinct-values($srsName)"/>). Dit is niet toegestaan. Zorg ervoor dat elke geometrie in de GIO hetzelfde ruimtelijke referentiesysteem(srsName) gebruikt.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
</sch:schema>

...
<sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
   ...
   <sch:pattern id="sch_data_005">
      <sch:title>AKN/JOIN validaties Expression/Work icm soortWork in ExpressionIdentificatie</sch:title>
      <sch:rule context="*:ExpressionIdentificatie">
	    ...
	    {"code": "STOP1013", "Work-ID": "<sch:value-of select="$Work"/>", "substring": "<sch:value-of select="$Work_documenttype"/>", "melding": "Derde veld <sch:value-of select="$Work_documenttype"/> in de AKN-identificatie <sch:value-of select="$Work"/> is niet toegestaan bij besluit. Pas dit veld aan.", "ernst": "fout"},</sch:report>
         <sch:p>AKN-identificatie (work) van (evt gecons) regeling of tijdelijkregelingdeel MOET als derde deel act
        hebben</sch:p>
        ...
        taal hebben</sch:p>
         ...
         <sch:p>Vierde deel AKN werken m.u.v. offpub MOET brp-code
        zijn (geconsolideerdeRegeling kan niet voorkomen in data:ExpressionIndentificatie).</sch:p>
         <sch:report id="STOP1010"
                     test="($is_akn or $is_join) and not($is_publicatie) and          not(matches($Work_overheid, $overheidexpressie))"
                     role="fout">
		  {"code": "STOP1010", "Work-ID": "<sch:value-of select="$Work"/>", "substring": "<sch:value-of select="$Work_overheid"/>", "melding": "Vierde deel van AKN/JOIN van werk (<sch:value-of select="$Work"/>) moet gelijk zijn aan een brp-code. Pas (<sch:value-of select="$Work_overheid"/>) aan.", "ernst": "fout"},</sch:report>
	    ...
	    {"code": "STOP1044", "Work-ID": "<sch:value-of select="$Work"/>", "substring": "<sch:value-of select="$Work_documenttype"/>", "melding": "Derde deel <sch:value-of select="$Work_documenttype"/> in de AKN-identificatie <sch:value-of select="$Work"/> is niet toegestaan voor een rectificatie. Pas dit deel aan.", "ernst": "fout"},</sch:report>
         <sch:p>Als FRBRWork begint met '/akn/nl/bill/' dan moet het soortwork
        '/join/id/stop/work_003' (generiek besluit) zijn.</sch:p>
	    ...
	    {"code": "STOP2002", "Work-ID": "<sch:value-of select="$Work"/>", "soortWork": "<sch:value-of select="$soortWork"/>", "melding": "FRBRWork '<sch:value-of select="$Work"/>' begint met '/akn/nl/bill/' maar soortwork'<sch:value-of select="$soortWork"/>' is niet gelijk aan '/join/id/stop/work_003'(besluit).", "ernst": "fout"},</sch:report>
         <sch:p>Als FRBRWork begint met "/akn/nl/act/" dan moet het 
        soortwork "/join/id/stop/work_019" (regeling), 
        of "/join/id/stop/work_006"  (geconsolideerde regeling), 
        of  "/join/id/stop/work_021" (tijdelijk regelingdeel), 
        of  "/join/id/stop/work_022" (consolidatie van tijdelijk regelingdeel) zijn.</sch:p>
	    ...
	    {"code": "STOP2003", "Work-ID": "<sch:value-of select="$Work"/>", "soortWork": "<sch:value-of select="$soortWork"/>", "melding": "FRBRWork '<sch:value-of select="$Work"/>' begint met '/akn/nl/act/' maar soortwork <sch:value-of select="$soortWork"/>' is niet gelijk aan '/join/id/stop/work_019'(regeling), '/join/id/stop/work_006'(geconsolideerde regeling), '/join/id/stop/work_021'(tijdelijk regelingdeel) of '/join/id/stop/work_019'(consolidatie van tijdelijk regelingdeel).", "ernst": "fout"},</sch:report>
         <sch:p>als FRBRWork begint met "/akn/nl/doc/" dan moet 
        soortwork "/join/id/stop/work_018" (rectificatie) 
        of "/join/id/stop/work_023" (kennisgeving) zijn.</sch:p>
	    ...
	    {"code": "STOP2052", "Work-ID": "<sch:value-of select="$Work"/>", "soortWork": "<sch:value-of select="$soortWork"/>", "melding": "FRBRWork '<sch:value-of select="$Work"/>' begint met '/akn/nl/doc/' maar soortwork <sch:value-of select="$soortWork"/>' is niet gelijk aan '/join/id/stop/work_018'(rectificatie) of '/join/id/stop/work_023'(kennisgeving).", "ernst": "fout"},</sch:report>
         <sch:p>als FRBRWork begint met "/join/id" dan moet 
        soortwork "/join/id/stop/work_010" (informatieobject) 
        of "/join/id/stop/work_005" (geconsolideerd informatieobject) zijn.</sch:p>
	    ...
	    {"code": "STOP2024", "Work-ID": "<sch:value-of select="$Work"/>", "soortWork": "<sch:value-of select="$soortWork"/>", "melding": "FRBRWork '<sch:value-of select="$Work"/>' begint met '/join/id' maar soortwork <sch:value-of select="$soortWork"/>' is niet gelijk aan '/join/id/stop/work_010'(informatieobject) of '/join/id/stop/work_005'(geconsolideerd informatieobject).", "ernst": "fout"},</sch:report>
         <sch:p>De identificatie van een tijdelijk regelingdeel (data:soortWork = '/join/id/stop/work_021') MOET
        aangeven waarvan het een tijdelijk deel is (heeft data:isTijdelijkDeelVan).</sch:p>
         <sch:report id="STOP2058"
                     test="$is_tijdelijkregelingdeel and not(./data:isTijdelijkDeelVan)"
                     role="fout">
	    {"code": "STOP2058", "Work-ID": "<sch:value-of select="$Work"/>", "melding": "De ExpressionIdentificatie('<sch:value-of select="$Work"/>') is van een tijdelijk regelingdeel (data:soortWork = '/join/id/stop/work_021') maar deze geeft niet aan van welke regeling het een tijdelijk deel is. Voeg data:isTijdelijkDeelVan toe.", "ernst": "fout"},</sch:report>
      </sch:rule>
   </sch:pattern>
   <sch:pattern id="sch_data_006">
      ...
      <sch:rule context="data:isTijdelijkDeelVan">
         ...
         <sch:let name="is_tijdelijkregelingdeel"
                  value="$soortWork = '/join/id/stop/work_021'"/>
         <sch:let name="TijdelijkDeel_is_regeling"
                  value="$soortWorkTijdelijkDeel = '/join/id/stop/work_019'"/>
         <sch:p>De identificatie van een tijdelijk regelingdeel (data:ExpressionIdentificatie bevat
        data:isTijdelijkDeelVan) MOET als soortWork '/join/id/stop/work_021'
        (tijdelijk regelingdeel) hebben.</sch:p>
         <sch:assert id="STOP2004" test="$is_tijdelijkregelingdeel" role="fout">
        {"code": "STOP2004", "soortWork": "<sch:value-of select="$soortWork"/>", "melding": "De ExpressionIdentificatie bevat data:isTijdelijkDeelVan, maar data:soortWork('<sch:value-of select="$soortWork"/>') is niet gelijk aan '/join/id/stop/work_021'(tijdelijk regelingdeel). Pas soortWork aan.", "ernst": "fout"},</sch:assert>
         <sch:p>De identificatie van een tijdelijk regelingdeel (ExpressionIdentificatie bevat
        data:isTijdelijkDeelVan) MOET tijdelijk deel zijn van FRBRWork 
        met als derde deel "/act/".</sch:p>
         <sch:assert id="STOP2054"
                     test="matches($WorkTijdelijkDeel_documenttype, '^act$')"
                     role="fout">
        {"code": "STOP2054", "Work-ID": "<sch:value-of select="$WorkTijdelijkDeel"/>", "melding": "De ExpressionIdentificatie bevat data:isTijdelijkDeelVan, maar is geen tijdelijk deel van een FRBRWork('<sch:value-of select="$WorkTijdelijkDeel"/>') met als derde deel '/act/'. Pas FRBRWork aan.", "ernst": "fout"},</sch:assert>
         <sch:p>De identificatie van een tijdelijk regelingdeel (ExpressionIdentificatie bevat
        data:isTijdelijkDeelVan) MOET tijdelijk deel zijn van een regeling met soortWork 
        '/join/id/stop/work_019' (regeling).</sch:p>
         <sch:assert id="STOP2057" test="$TijdelijkDeel_is_regeling" role="fout">
        {"code": "STOP2057", "soortWork": "<sch:value-of select="$soortWorkTijdelijkDeel"/>", "melding": "De ExpressionIdentificatie bevat data:isTijdelijkDeelVan, maar het soortWork('<sch:value-of select="$soortWorkTijdelijkDeel"/>') van de regeling waar deze regeling een tijdelijk deel van is, is niet gelijk aan '/join/id/stop/work_019' (regeling). Pas soortWork aan.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern>

  ...
  -->
   ...
   <sch:pattern id="sch_tekst_014">
      ...
      <sch:rule context="tekst:table">
         <sch:assert id="STOP0029"
                     test="number(tekst:tgroup/@cols) &gt;= 2"
                     role="waarschuwing"> {"code": "STOP0029", "eId": "<sch:value-of select="@eId"/>", "melding": "De tabel met <sch:value-of select="@eId"/> heeft slechts 1 kolom, dit is niet toegestaan. Pas de tabel aan, of plaats de inhoud van de tabel naar bijvoorbeeld een element Kadertekst", "ernst": "waarschuwing"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern id="sch_tekst_040">
      ...
      <sch:rule context="tekst:Artikel">
         ...
         <sch:assert id="STOP0059"
                     test="child::tekst:*[not(self::tekst:Kop)]"
                     role="fout"> {"code": "STOP0059", "naam": "<sch:name/>", "eId": "<sch:value-of select="@eId"/>", "melding": "Het element <sch:name/> met eId: \"<sch:value-of select="@eId"/> is niet compleet, een kind-element anders dan een Kop is verplicht. Completeer of verwijder dit element.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <xsl:key match="tekst:Noot[not(ancestor-or-self::tekst:*[@componentnaam])][not(ancestor-or-self::tekst:WijzigInstructies)]"
            name="alleNootIDs"
            use="@id"/>
   <sch:pattern id="sch_tekst_0046">
      <sch:title>Noot/@id is uniek binnen component (kan niet in XSD vanwege component)</sch:title>

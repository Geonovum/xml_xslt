...
<sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
   ...
   <sch:pattern id="sch_data_010">
      ...
      <sch:rule context="data:opvolgerVan">
         ...
         <sch:assert id="STOP1024"
                     ...
                     role="fout">
        {"code": "STOP1024", "substring": "<sch:value-of select="./string()"/>", "melding": "In opvolgerVan (<sch:value-of select="./string()"/>) wordt niet verwezen naar een expression van een Regeling of Informatieobject ('/AKN/act/...' of '/join/id/regdata/...'). Corrigeer de verwijzing opvolgerVan.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern id="sch_data_012">
      ...
      <sch:rule context="data:OfficielePublicatieMetadata[data:soortPublicatie = '/join/id/stop/soortpublicatie_002']">
         <sch:report id="STOP1033" test="data:ondertekendOp" role="fout"> {"code": "STOP1033", "melding": "De officiële publicatie van een besluit heeft ten onrechte een datum ondertekening.", "ernst": "fout"},</sch:report>
      </sch:rule>
   </sch:pattern>
   ...
   <sch:pattern id="sch_data_015">
      <sch:rule context="*:heeftGeboorteregeling">
         ...
         <sch:assert id="STOP1060"
                     ...
                     role="fout">
        {"code": "STOP1060", "Expressie": "<sch:value-of select="."/>", "melding": "heeftGeboorteregeling verwijst naar <sch:value-of select="."/>. Dit is geen expression van een Regeling ('/AKN/nl/act/...'). Corrigeer de verwijzing heeftGeboorteregeling.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
</sch:schema>

...
<sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
   ...
   <sch:pattern id="sch_uws_004">
      <sch:title>Component in een pakbon heeft id-module</sch:title>
      <sch:rule context="uws:Component" id="STOP1208">
         <sch:assert test="uws:heeftModule/uws:Module[uws:namespace=$nsd][normalize-space(uws:localName)='ExpressionIdentificatie']         |uws:heeftModule/uws:Module[uws:namespace=$nsc][normalize-space(uws:localName)='ConsolidatieIdentificatie']"
                     role="waarschuwing">

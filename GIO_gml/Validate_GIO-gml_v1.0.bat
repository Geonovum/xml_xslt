...
FORFILES /m *.gml /C "cmd /c D:\Apps\QGIS\OSGeo4W64\bin\ogrinfo.exe @fname -sql \"SELECT IsValid(geometrie) FROM locatie WHERE IsValid(geometrie)=0\" >>Validate_result.txt"
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:key name="RegelingId" match="regeling" use="origineleregelingFBRWork"/>
    ...
    <xsl:template match="Regeling[not(generate-id() = generate-id(key('RegelingId', origineleregelingFBRWork)[1]))]">
    </xsl:template>
